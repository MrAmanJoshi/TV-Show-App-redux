...
export const showLoadingSelector = createSelector(stateSelector, (showState) => showState.show_loading
)

export const showMapSelector = createSelector(stateSelector, (showState) => showState.show
);
